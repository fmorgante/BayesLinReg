...
RcppExport SEXP _BayesLinReg_blm_gibbs_block_rcpp_cpp(SEXP residual_shapeSEXP, SEXP residual_scaleSEXP, SEXP iterationsSEXP, SEXP burninSEXP, SEXP thinSEXP, SEXP progress_callbackSEXP, SEXP block_idSEXP, SEXP block_modelSEXP, SEXP normal_shapeSEXP, SEXP normal_scaleSEXP, SEXP pi_alphaSEXP, SEXP pi_betaSEXP, SEXP spike_var_shapeSEXP, SEXP spike_var_scaleSEXP, SEXP global_scaleSEXP, SEXP local_aSEXP, SEXP local_bSEXP, SEXP multi_gamma_listSEXP, SEXP multi_pi_alpha_listSEXP, SEXP multi_var_shapeSEXP, SEXP multi_var_scaleSEXP, SEXP learn_residual_varSEXP, SEXP fixed_residual_varSEXP, SEXP store_samplesSEXP, SEXP store_coefficient_covSEXP, SEXP effective_nSEXP, SEXP fit_interceptSEXP, SEXP intercept_x_meanSEXP, SEXP intercept_y_meanSEXP, SEXP summary_XtXSEXP, SEXP summary_indicesSEXP, SEXP summary_typesSEXP, SEXP summary_centerSEXP, SEXP summary_XtySEXP, SEXP summary_ytySEXP, SEXP compute_pveSEXP, SEXP pve_type_codeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const double >::type residual_shape(residual_shapeSEXP);
    ...
    Rcpp::traits::input_parameter< const bool >::type compute_pve(compute_pveSEXP);
    Rcpp::traits::input_parameter< const int >::type pve_type_code(pve_type_codeSEXP);
    rcpp_result_gen = Rcpp::wrap(blm_gibbs_block_rcpp_cpp(residual_shape, residual_scale, iterations, burnin, thin, progress_callback, block_id, block_model, normal_shape, normal_scale, pi_alpha, pi_beta, spike_var_shape, spike_var_scale, global_scale, local_a, local_b, multi_gamma_list, multi_pi_alpha_list, multi_var_shape, multi_var_scale, learn_residual_var, fixed_residual_var, store_samples, store_coefficient_cov, effective_n, fit_intercept, intercept_x_mean, intercept_y_mean, summary_XtX, summary_indices, summary_types, summary_center, summary_Xty, summary_yty, compute_pve, pve_type_code));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_BayesLinReg_blm_gibbs_block_rcpp_cpp", (DL_FUNC) &_BayesLinReg_blm_gibbs_block_rcpp_cpp, 37},
    {NULL, NULL, 0}
};
