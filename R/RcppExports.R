...
eigen_matrix_is_finite_cpp <- function(eigenvectors) {
    .Call(`_BayesLinReg_eigen_matrix_is_finite_cpp`, eigenvectors)
}
...
compress_dense_ld_blocks_cpp <- function(matrix, label, max_stored_values) {
    .Call(`_BayesLinReg_compress_dense_ld_blocks_cpp`, matrix, label, max_stored_values)
}
